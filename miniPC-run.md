...
# 终端 2b: TF桥
cd ~/2026Gsing/2026_Gsing-second_ROS/fastlio2_v2 && source install/setup.bash && ./build/fast_lio/odometry_to_tf

# 终端 3: Nav2
cd ~/2026Gsing/2026_Gsing-second_ROS/nav2_ws1 && source install/setup.bash && ros2 launch dog_nav2_bringup nav2_fastlio_static_map.launch.py map:=map/map.yaml start_rviz:=false

# 终端 4: 串口桥
cd ~/2026Gsing/2026_Gsing-second_ROS/nav2_ws1 && source install/setup.bash && ros2 launch dog_nav2_bringup chassis_serial_bridge.launch.py serial_port:=/dev/ttyACM0 baud_rate:=115200
```
