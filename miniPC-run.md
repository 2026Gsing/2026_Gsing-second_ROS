...
# 终端 2: ICP
cd ~/2026Gsing/2026_Gsing-second_ROS/fastlio2_v2 && source install/setup.bash && export AMENT_PREFIX_PATH="$PWD/install/fast_lio_localization:$AMENT_PREFIX_PATH" && export PYTHONPATH=$PYTHONPATH:$HOME/.local/lib/python3.10/site-packages && ros2 launch fast_lio_localization 1.launch.py map:=map/map.pcd config_file:=unilidar_l2.yaml rviz:=false map_voxel_size:=0.01 scan_voxel_size:=0.03 freq_localization:=2.0 localization_threshold:=0.9
